...
BINDPAD_TITLE_PROFILE = "BindPad Profile";
...
BINDPAD_TEXT_SHOW_KEY_IN_TOOLTIP = "Show Keys in Tooltip";
...
BINDPAD_TOOLTIP_SHOW_KEY_IN_TOOLTIP = "Show keybindings in tooltip for spells, items, and macros on ActionBar and Spellbook.";
